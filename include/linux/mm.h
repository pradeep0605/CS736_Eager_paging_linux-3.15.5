...
extern int handle_mm_fault_apriori_paging(struct mm_struct *mm, struct vm_area_struct *vma,
...
static inline void mm_populate(unsigned long addr, unsigned long len, unsigned long apriori_flag)
{
	/* Ignore errors */
